...
export function BackendQuadTreeDemoPage({ title }: DemoPageProps) {
  ...
  return (
    ...
    <section>
      ...
      <p>The result is a separation of concerns: the Go backend is the single source of truth for positions, collisions, and the browser's only job is to interpolate between snapshots and draw both the sprites and the search structure that found their collisions.</p>
    </section>
    </>
  );
}
